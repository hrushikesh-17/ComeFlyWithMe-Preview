...
export const data = {
  title: "Vietnam Family Standard",

  heroImg: vietnam2,

  content: [
    `Experience Vietnam with your family through a comfortable journey filled with beautiful landscapes, delicious food, rich culture, and unforgettable experiences.`,
    ...
    `This Standard package is designed for families who want a comfortable Vietnam holiday with a balanced combination of sightseeing, relaxation, culture, food, adventure, and family fun.`,
  ],
  ...
  planTitle: "Vietnam Family Standard",

  plans: [
    {
      title: "Vietnam Family Standard Adventure",

      data: [
        `Discover Vietnam together as a family while exploring beautiful destinations, experiencing local culture, enjoying delicious Vietnamese cuisine, and creating wonderful memories.`,

        `Enjoy a comfortable family journey with a balanced combination of sightseeing, adventure, relaxation, cultural experiences, and quality time together.`,

        `From vibrant streets and cultural destinations to beautiful natural landscapes, this Standard package is designed to make your family trip enjoyable, comfortable, and memorable.`,
      ],

      url: "/vietnam/family/standard",
