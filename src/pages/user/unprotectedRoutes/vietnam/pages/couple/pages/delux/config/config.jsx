...
export const data = {
  title: "Vietnam Couple Delux",

  heroImg: vietnam3,

  content: [
    `Experience Vietnam with your partner through a deluxe romantic journey filled with beautiful landscapes, delicious food, rich culture, exciting experiences, and unforgettable moments.`,

    `Explore charming streets together, discover fascinating cultural destinations, enjoy breathtaking natural scenery, and create beautiful memories as a couple.`,

    `This Deluxe package is designed for couples who want a more comfortable Vietnam holiday with the perfect combination of sightseeing, adventure, relaxation, culture, food, and romantic experiences.`,
  ],
  ...
  planTitle: "Vietnam Couple Delux",

  plans: [
    {
      title: "Vietnam Couple Deluxe Escape",
      ...
      data: [
        ...
        `Enjoy a comfortable deluxe romantic journey combining sightseeing, adventure, relaxation, cultural experiences, delicious food, and quality time together.`,

        `From vibrant cities and historic destinations to breathtaking natural landscapes, this Deluxe package is designed to make your Vietnam couple's trip comfortable, exciting, romantic, and memorable.`,
      ],

      url: "/vietnam/couple/delux",
    ...
    plans: [
...

      {
        ...
        data: [
          ...
          "Relax together while taking in the spectacular views",
          "Spend peaceful time as a couple",
        ],
      },
    ],
  },
    ...
    plans: [
...

      {
        ...
        data: [
          ...
          "Share a memorable dinner together",
        ],
      },
    ],
  },
    ...
    plans: [
      {
        ...
        data: [
          ...
          "Take your special Vietnam memories with you",
        ],
      },
    ],
  },
