...
export const data = {
  title: "Vietnam Custom Standard",

  heroImg: vietnam2,

  content: [
    `Create your own Vietnam journey with a flexible holiday designed around your interests, travel style, and budget.`,

    `Explore beautiful landscapes, vibrant cities, cultural destinations, local markets, delicious Vietnamese cuisine, and unforgettable experiences at your own pace.`,

    `This Standard Custom package gives you the freedom to combine sightseeing, adventure, relaxation, culture, and food while creating memories that are completely your own.`,
  ],
  ...
  planTitle: "Vietnam Custom Standard",

  plans: [
    {
      title: "Vietnam Custom Standard Journey",

      data: [
        `Design your Vietnam experience around the places and activities you enjoy most. Discover beautiful destinations, local culture, delicious food, and memorable experiences at your own pace.`,

        `Enjoy the flexibility to combine sightseeing, adventure, relaxation, cultural experiences, and local cuisine according to your travel preferences.`,

        `Whether you want to explore vibrant cities, discover peaceful landscapes, experience Vietnamese culture, or simply relax, this Custom Standard package gives you the freedom to create your ideal journey.`,
      ],

      url: "/vietnam/custom/standard",
