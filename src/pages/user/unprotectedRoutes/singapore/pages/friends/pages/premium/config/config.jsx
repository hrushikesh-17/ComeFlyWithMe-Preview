...
export const data = {
  title: "Singapore Friends Premium",

  heroImg: singapore5,

  content: [
    "Experience Singapore with your closest friends through a premium journey filled with modern attractions, delicious food, exciting activities, comfort, and unforgettable experiences.",

    "Explore Singapore's vibrant city atmosphere, discover its unique culture, enjoy beautiful landmarks, and spend memorable moments together with your friends.",

    "This Premium package is designed for friends who want a comfortable and memorable Singapore holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and fun.",
  ],
...
export const activities = [
  {
    ...
    plans: [
      ...
      },
      {
        title: "Activities",
        data: [
          "Explore nearby streets and attractions",
          "Enjoy your first Singaporean meal with your friends",
        ],
      },
    ],
  },
  ...
  {
    day: 4,
    title: "Sentosa Premium Experience",
    image: singapore4,
    color: "83D3FC",
