...
export const data = {
  ...
  content: [
    ...
    "This Premium package offers a more comfortable Malaysia holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and flexibility.",
  ],
    ...
    plans: [
      {
        title: "Activities",
        data: [
          "Choose a premium adventure activity based on your interests",
