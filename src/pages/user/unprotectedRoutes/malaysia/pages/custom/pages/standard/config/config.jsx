...
export const data = {
  ...
  content: [
    ...
    "This Standard package offers a comfortable Malaysia holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and flexibility.",
  ],
