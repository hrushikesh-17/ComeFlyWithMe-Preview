...
export const data = {
  ...
  content: [
    ...
    "Explore Malaysia's vibrant cities, discover local culture, enjoy beautiful scenery, and create memorable moments together as a family.",

    "This Delux package is designed for families who want a comfortable Malaysia holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and family fun.",
  ],
    ...
    plans: [
      ...
      },
      {
        ...
        data: [
          ...
          "Spend a relaxed family evening",
        ],
      },
    ],
  },
