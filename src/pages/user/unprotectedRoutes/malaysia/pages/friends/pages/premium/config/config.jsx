...
import malaysia1 from "@/assets/malaysia1.jpg";
import malaysia2 from "@/assets/malaysia2.jpg";
import malaysia3 from "@/assets/malaysia3.jpg";
import malaysia4 from "@/assets/malaysia4.jpg";
import malaysia5 from "@/assets/malaysia5.jpg";
...
export const data = {
  title: "Malaysia Friends Premium",

  heroImg: malaysia3,

  content: [
    `Experience Malaysia with your closest friends through a premium journey filled with beautiful places, delicious food, exciting activities, comfort, and unforgettable experiences.`,

    `Explore Malaysia's vibrant cities, discover local culture, enjoy beautiful scenery, and create special memories together with your friends.`,

    `This Premium package is designed for friends who want a more comfortable Malaysia holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and fun.`,
  ],
