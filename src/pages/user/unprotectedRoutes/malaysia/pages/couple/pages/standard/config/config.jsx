...
export const data = {
  ...
  content: [
    ...
    "This Standard package is designed for couples who want a comfortable Malaysia holiday with a balanced combination of sightseeing, relaxation, culture, food, adventure, and quality time together.",
  ],
