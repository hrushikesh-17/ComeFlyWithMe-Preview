...
export const data = {
  ...
  content: [
    ...
    "This Delux package is designed for couples who want a comfortable Malaysia holiday with a balanced combination of sightseeing, adventure, relaxation, culture, food, and quality time together.",
  ],
